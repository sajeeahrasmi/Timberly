...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `crudpost` (`category`, `type`, `length`, `width`, `height`, `quantity`, `info`, `image`, `supplierId`) 
            VALUES ('$category', '$type', '$length', '$width', '$height', '$quantity', '$info', '$image', '{$_SESSION['userId']}')";
...
<div class="body-content-wrapper">
    <div class="sidebar">
        <div class="sidebar-content">
            ...
            <a href="http://localhost/Timberly/config/logout.php" class="sidebar-link">Log Out</a>
        </div>
    </div>
