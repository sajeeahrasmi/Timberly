<?php 
include '../../api/fetechRejectedPost.php'; // Fetch rejected posts
?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <?php if (!empty($orders)): ?>
                        <?php foreach ($orders as $order): ?>
                            <tr>
                                ...
                                <td class="po"><?= ($order['status'] = 'Rejected') ? 'Rejected' : 'Pending' ?></td>
                                <td>
                                <span class="view-btn"
                                    ...
                                    data-status="<?= $order['status'] == 'Approved' ? 'Approved' : 'Rejected' ?>"
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="8" style="text-align:center;">No rejected orders found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
