<?php
    ...
    include '../../api/getEditSupplier.php';
?>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./styles/editSupplier.css">
        ...
        <div class="dashboard-container">
            ...
            <div class="main-content" style="margin-left: 300px">
                ...
                <div class="main-content">
                    <div class="card">
                        <form id="edit-supplier-form" class="edit-supplier-form" method="POST" action="../../api/getEditSupplier.php?supplier_id=<?php echo htmlspecialchars($user_id); ?>" onsubmit="return validateForm()">
                            <h2 style="margin-left: 15px; margin-bottom: 30px">Edit Supplier</h2>
    ...
    <script> src="./scripts/editSupplier.js"</script>
</html>
